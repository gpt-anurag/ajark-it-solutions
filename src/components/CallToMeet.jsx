...
const CallToMeet = () => {
  return (
    <section className='bg-[#11423c] text-white text-xl'>
      <div className='w-2/3 my-0 mx-auto pb-24 pt-12 flex flex-col items-center gap-12'>
        ...
        <div className='grid grid-cols-12 justify-between gap-5  mb-8'>
          <div className='col-span-5 text-2xl text-center place-content-center'>
            whether you’re a student eager to kickstart your career
          </div>
          <h2 className='text-8xl col-span-2 text-center place-content-center'>
            or
          </h2>
          <div className='col-span-5 text-2xl text-center place-content-center'>
